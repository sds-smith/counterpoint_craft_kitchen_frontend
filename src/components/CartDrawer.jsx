...
export default function CartDrawer() {
    ...
    return (
      ...
      >
        <Box sx={{height: '70vh'}}>
            <Typography variant='h4' textAlign='center'>My {capitalize(method)} Order</Typography>
            ...
            {Object.entries(cartItems).map(([id, quantity]) => <CartItemCard key={id} id={id} quantity={quantity} />)}
